  ...
  return [
    ...
    },
    {
      ...
      migrate: (ctx, finding) => ({
        ...
        changedFiles: [],
        details: finding.details.length ? [...finding.details, `Edit ${join4(ctx.homeDir, ".hermes", "config.yaml")} directly, then re-run audit`] : [`Edit ${join4(ctx.homeDir, ".hermes", "config.yaml")} directly, then re-run audit`]
      })
    },
    {
